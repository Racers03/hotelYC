...
<body>
      ...
      <fieldset>
      <label>Nama Pekerja:</label><input type="text"
      name="nama_pekerja" id="nama_pekerja"  /><br><br>
      <label>Nama Pengguna:</label><input type="text"
      name="nama" id="nama"  /><br><br>
      <label>Kata Laluan:</label><input type="text"
      name="katalaluan" id="katalaluan"  />
