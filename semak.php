  ...
  <body>
    <center>
      <table width="711" border="0">
        <td>
          <p><strong>SENARAI STATUS TEMPAHAN BILIK</strong></p>
          <table width="1000" border="1" align="center">
            ...
            <tr>
              ...
              <td>RN <?php echo number_format($jumBesar, 2); ?></td>
              <td></td>
            </tr>
          </table>
          <br />
        </td>
        <div align="center" class="style15">* Laporan Tamat *<br />Jumlah Rekod:<?php echo $no - 1; ?></div>
        <center>
