...
$sql = "INSERT INTO pelanggan (idpelanggan,nama,nomhp)
VALUES ('$id','$nama','$hp')";
...
negeri,idpelanggan)
VALUES (NULL,'$alamat1','$alamat2','$poskod','$bandar','$negeri','$id')";
...
<form method="POST"> 
    ...
    placeholder="Alamat2" size="60"><br>
    ...
    placeholder="Negeri" size="30" required ><br><br>
<button type="submit">Daftar</button>
<button type="reset">Reset</button><br><br>
*Pastikan semua maklumat ditaip dengan teliti.
</form>
<form action="index2.php"><button type="submit">Home</button><br><br>
</fieldset>
</body>
</html>